...
class Rules implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rules';
    ...
    /**
     * Sets links
     * @param \Swagger\Client\Model\BeezUPCommonLink2[] $links Links to know if the user can create a rule or run all rules
     * @return $this
     */
