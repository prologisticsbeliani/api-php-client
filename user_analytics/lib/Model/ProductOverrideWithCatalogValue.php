...
/**
 * ProductOverrideWithCatalogValue Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductOverrideWithCatalogValue implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productOverrideWithCatalogValue';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['catalog_value'] = isset($data['catalog_value']) ? $data['catalog_value'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['override'] === null) {
            $invalid_properties[] = "'override' can't be null";
        }
    ...
    /**
     * Sets override
     * @param string $override The overrided product value
     * @return $this
     */
    ...
    {
        return $this->container['catalog_value'];
    }

    /**
     * Sets catalog_value
     * @param string $catalog_value The catalog product value
     * @return $this
     */
    public function setCatalogValue($catalog_value)
    {
        $this->container['catalog_value'] = $catalog_value;
