...
/**
 * ChannelCatalogsCategoryMappingsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ChannelCatalogsCategoryMappingsApi
{
     ...
     *
     * @return ChannelCatalogsCategoryMappingsApi
     */
    ...
    public function getChannelCatalogCategoriesWithHttpInfo($channel_catalog_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/categoryMappings";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/{channelCatalogId}/categoryMappings'
            );
    ...
    public function mapChannelCatalogCategoryWithHttpInfo($channel_catalog_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/categoryMappings/map";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{channelCatalogId}/categoryMappings/map'
            );
    ...
    public function unmapChannelCatalogCategoryWithHttpInfo($channel_catalog_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/categoryMappings/unmap";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{channelCatalogId}/categoryMappings/unmap'
            );
