...
class PublicationsApi
{
    ...
    public function getPublicationsWithHttpInfo($marketplace_technical_code, $account_id, $channel_catalog_id = null, $count = null, $publication_types = null)
    {
        ...
        if (!is_null($count) && ($count > 100)) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling PublicationsApi.getPublications, must be smaller than or equal to 100.');
        }
        if (!is_null($count) && ($count < 10)) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling PublicationsApi.getPublications, must be bigger than or equal to 10.');
        }
