...
class OrderListRequest implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['date_search_type'] === null) {
            $invalid_properties[] = "'date_search_type' can't be null";
        }
        ...
        if ($this->container['page_size'] === null) {
            $invalid_properties[] = "'page_size' can't be null";
        }
     ...
     * @param \Swagger\Client\Model\BeezUPCommonMarketplaceTechnicalCode[] $marketplace_technical_codes
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\BeezUPCommonMarketplaceBusinessCode[] $marketplace_business_codes
     * @return $this
     */
