# Swagger\Client\ExclusionFiltersApi

All URIs are relative to *https://api.beezup.com/v2/user/channelCatalogs*

Method | HTTP request | Description
------------- | ------------- | -------------
[**configureChannelCatalogExclusionFilters**](ExclusionFiltersApi.md#configureChannelCatalogExclusionFilters) | **PUT** /{channelCatalogId}/exclusionFilters | Configure channel catalog exclusion filters
[**getChannelCatalogExclusionFilterOperators**](ExclusionFiltersApi.md#getChannelCatalogExclusionFilterOperators) | **GET** /exclusionFilterOperators | Get channel catalog exclusion filter operators
...
$api_instance = new Swagger\Client\Api\ExclusionFiltersApi();
...
try {
    ...
    echo 'Exception when calling ExclusionFiltersApi->configureChannelCatalogExclusionFilters: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling ExclusionFiltersApi->getChannelCatalogExclusionFilterOperators: ', $e->getMessage(), PHP_EOL;
}
?>
```
