...
class CatalogApi
{
    ...
    public function catalogChangeCatalogColumnUserNameWithHttpInfo($store_id, $column_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/catalogColumns/{columnId}/rename";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/catalogColumns/{columnId}/rename'
            );
    ...
    public function catalogChangeCustomColumnExpressionWithHttpInfo($store_id, $column_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/customColumns/{columnId}/expression";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/customColumns/{columnId}/expression'
            );
    ...
    public function catalogChangeCustomColumnUserNameWithHttpInfo($store_id, $column_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/customColumns/{columnId}/rename";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/customColumns/{columnId}/rename'
            );
    ...
    public function catalogComputeExpressionWithHttpInfo($store_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/customColumns/computeExpression";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                'string',
                '/{storeId}/customColumns/computeExpression'
            );
    ...
    public function catalogDeleteCustomColumnWithHttpInfo($store_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/customColumns/{columnId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/customColumns/{columnId}'
            );
    ...
    public function catalogGetCatalogColumnsWithHttpInfo($store_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/catalogColumns";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function catalogGetCategoriesWithHttpInfo($store_id, $accept_encoding)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/categories";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function catalogGetCustomColumnsWithHttpInfo($store_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/customColumns";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function catalogGetProductWithHttpInfo($store_id, $product_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/products/{productId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function catalogGetRandomProductsWithHttpInfo($store_id, $count = null)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/products/random";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function importationGetManualUpdateLastInputConfigWithHttpInfo($store_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/inputConfiguration";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
