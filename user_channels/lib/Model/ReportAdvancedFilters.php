...
class ReportAdvancedFilters implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['global_margin_percent']) && ($this->container['global_margin_percent'] > 100)) {
            $invalid_properties[] = "invalid value for 'global_margin_percent', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['global_margin_percent']) && ($this->container['global_margin_percent'] < 0)) {
            $invalid_properties[] = "invalid value for 'global_margin_percent', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['link_click_to_order_max_day']) && ($this->container['link_click_to_order_max_day'] > 180)) {
            $invalid_properties[] = "invalid value for 'link_click_to_order_max_day', must be smaller than or equal to 180.";
        }

        if (!is_null($this->container['link_click_to_order_max_day']) && ($this->container['link_click_to_order_max_day'] < 0)) {
            $invalid_properties[] = "invalid value for 'link_click_to_order_max_day', must be bigger than or equal to 0.";
        }
