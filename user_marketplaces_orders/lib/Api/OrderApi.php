...
class OrderApi
{
    ...
    public function changeOrderWithHttpInfo($marketplace_technical_code, $account_id, $beez_up_order_id, $change_order_type, $user_name, $request, $if_match, $test_mode = null)
    {
        ...
        // parse inputs
        $resourcePath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/{changeOrderType}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function clearMerchantOrderInfoWithHttpInfo($marketplace_technical_code, $account_id, $beez_up_order_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/clearMerchantOrderInfo";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function getOrderWithHttpInfo($marketplace_technical_code, $account_id, $beez_up_order_id, $if_none_match = null)
    {
        ...
        // parse inputs
        $resourcePath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function getOrderHistoryWithHttpInfo($marketplace_technical_code, $account_id, $beez_up_order_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/history";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function harvestOrderWithHttpInfo($marketplace_technical_code, $account_id, $beez_up_order_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/harvest";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function setMerchantOrderInfoWithHttpInfo($marketplace_technical_code, $account_id, $beez_up_order_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{marketplaceTechnicalCode}/{accountId}/{beezUPOrderId}/setMerchantOrderInfo";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
