 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChangePasswordRequest implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_password'] === null) {
            $invalid_properties[] = "'new_password' can't be null";
        }
    ...
    /**
     * Sets new_password
     * @param string $new_password Your new password. Which must respect the same constraints as the user registeration
     * @return $this
     */
