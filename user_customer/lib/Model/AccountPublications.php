 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AccountPublications implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'accountPublications';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['publications'] === null) {
            $invalid_properties[] = "'publications' can't be null";
        }
    ...
    /**
     * Sets links
     * @param \Swagger\Client\Model\AccountPublicationsLinks $links
     * @return $this
     */
