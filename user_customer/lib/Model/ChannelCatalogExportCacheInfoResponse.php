 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChannelCatalogExportCacheInfoResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'channelCatalogExportCacheInfoResponse';
    ...
    {
        $this->container['cache_info'] = isset($data['cache_info']) ? $data['cache_info'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cache_info'] === null) {
            $invalid_properties[] = "'cache_info' can't be null";
        }
    ...
    {
        return $this->container['cache_info'];
    }

    /**
     * Sets cache_info
     * @param \Swagger\Client\Model\ChannelCatalogExportCacheInfo $cache_info
     * @return $this
     */
    public function setCacheInfo($cache_info)
    {
        $this->container['cache_info'] = $cache_info;
    ...
    /**
     * Sets links
     * @param \Swagger\Client\Model\ChannelCatalogExportCacheInfoResponseLinks $links
     * @return $this
     */
