...
/**
 * ExclusionFiltersApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ExclusionFiltersApi
{
    ...
    public function configureChannelCatalogExclusionFiltersWithHttpInfo($channel_catalog_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/exclusionFilters";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{channelCatalogId}/exclusionFilters'
            );
    ...
    {
        // parse inputs
        $resourcePath = "/exclusionFilterOperators";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
