...
class GeneralSettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        'accept_to_publish_info' => null,
        'do_not_export_out_of_stock_products' => null,
        'active_beez_up_tracking' => null
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accept_to_publish_info'] === null) {
            $invalidProperties[] = "'accept_to_publish_info' can't be null";
        }
        if ($this->container['do_not_export_out_of_stock_products'] === null) {
            $invalidProperties[] = "'do_not_export_out_of_stock_products' can't be null";
        }
        if ($this->container['active_beez_up_tracking'] === null) {
            $invalidProperties[] = "'active_beez_up_tracking' can't be null";
        }
