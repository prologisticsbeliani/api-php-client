 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ReportByProductRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'reportByProductRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'product_columns_to_display' => '\Swagger\Client\Model\BeezUPCommonCatalogColumnId[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_state'] === null) {
            $invalid_properties[] = "'product_state' can't be null";
        }
     ...
     * @param \Swagger\Client\Model\BeezUPCommonCatalogColumnId[] $product_columns_to_display
     * @return $this
     */
