 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketplaceChannelCatalogList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        'links' => null,
        'marketplace_channel_catalogs' => null
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['marketplace_channel_catalogs'] === null) {
            $invalidProperties[] = "'marketplace_channel_catalogs' can't be null";
        }
