 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SaveReportFilterRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'saveReportFilterRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['report_filter_name'] === null) {
            $invalidProperties[] = "'report_filter_name' can't be null";
        }
