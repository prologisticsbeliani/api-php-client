 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChannelCatalogExportCacheInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        ...
        'last_content_change_utc_date' => 'date-time',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cache_status'] === null) {
            $invalidProperties[] = "'cache_status' can't be null";
        }
