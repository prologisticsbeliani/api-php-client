 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ComputeExpressionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'computeExpressionRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_values'] === null) {
            $invalidProperties[] = "'product_values' can't be null";
        }
