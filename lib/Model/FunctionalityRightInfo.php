 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FunctionalityRightInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        'functionality_code' => null,
        'max_value_interger' => null,
        'unlimited' => null
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['functionality_code'] === null) {
            $invalidProperties[] = "'functionality_code' can't be null";
        }
