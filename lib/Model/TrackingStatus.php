...
class TrackingStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        'click_synchronization_utc_date' => 'date-time',
        'order_synchonization_utc_date' => 'date-time',
        'marketplace_order_synchonization_utc_date' => 'date-time'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['click_synchronization_utc_date'] === null) {
            $invalidProperties[] = "'click_synchronization_utc_date' can't be null";
        }
        if ($this->container['order_synchonization_utc_date'] === null) {
            $invalidProperties[] = "'order_synchonization_utc_date' can't be null";
        }
        if ($this->container['marketplace_order_synchonization_utc_date'] === null) {
            $invalidProperties[] = "'marketplace_order_synchonization_utc_date' can't be null";
        }
     ...
     *
     * @param \DateTime $click_synchronization_utc_date The utc date of the latest synchronized click
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $order_synchonization_utc_date The utc date of the latest synchronized order
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $marketplace_order_synchonization_utc_date The utc date of the latest synchronized marketplace order
     *
     * @return $this
     */
