 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TrackingStatus implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['click_synchronization_utc_date'] === null) {
            $invalid_properties[] = "'click_synchronization_utc_date' can't be null";
        }
        if ($this->container['order_synchonization_utc_date'] === null) {
            $invalid_properties[] = "'order_synchonization_utc_date' can't be null";
        }
        if ($this->container['marketplace_order_synchonization_utc_date'] === null) {
            $invalid_properties[] = "'marketplace_order_synchonization_utc_date' can't be null";
        }
