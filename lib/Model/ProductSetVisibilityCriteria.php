 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductSetVisibilityCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productSetVisibilityCriteria';
     ...
     * Sets exist
     *
     * @param bool $exist If false, search for products absent from the current catalog. If true, search for products currently in the catalog. If null the filter will not be taken in account.
     *
     * @return $this
     */
     ...
     * Sets uncategorized
     *
     * @param bool $uncategorized Search product WITHOUT category mapped with the channel. If null the filter will not be taken in account.
     *
     * @return $this
     */
