 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CatalogIndexLinks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'catalogIndexLinks';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['beez_up_columns'] === null) {
            $invalidProperties[] = "'beez_up_columns' can't be null";
        }
