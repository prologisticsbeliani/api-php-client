 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChannelCategoryColumnOverride implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        ...
        'channel_column_description' => null,
        'show_in_mapping' => null,
        'configuration' => null,
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['show_in_mapping'] === null) {
            $invalidProperties[] = "'show_in_mapping' can't be null";
        }
