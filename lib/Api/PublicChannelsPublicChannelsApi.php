...
class PublicChannelsPublicChannelsApi
{
    ...
    {
        list($response) = $this->getChannelsWithHttpInfo($country_iso_code, $accept_encoding, $if_none_match);
        return $response;
    }
     ...
     */
    public function getChannelsAsync($country_iso_code, $accept_encoding, $if_none_match = null)
    {
        return $this->getChannelsAsyncWithHttpInfo($country_iso_code, $accept_encoding, $if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getChannelsRequest($country_iso_code, $accept_encoding, $if_none_match = null)
    {
        // verify the required parameter 'country_iso_code' is set
        if ($country_iso_code === null || (is_array($country_iso_code) && count($country_iso_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_iso_code when calling getChannels'
            );
        }
        ...
        if ($accept_encoding === null || (is_array($accept_encoding) && count($accept_encoding) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept_encoding when calling getChannels'
            );
        }

        $resourcePath = '/public/channels/{countryIsoCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($country_iso_code !== null) {
            $resourcePath = str_replace(
                '{' . 'countryIsoCode' . '}',
                ObjectSerializer::toPathValue($country_iso_code),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->getChannelsIndexWithHttpInfo($if_none_match);
        return $response;
    }
    ...
    /**
     * Operation getChannelsIndexAsync
     *
     * Get public channel index
     *
     * @param  string $if_none_match ETag value to identify the last known version of requested resource.\\ To avoid useless exchange, we recommend you to indicate the ETag you previously got from this operation.\\ If the ETag value does not match the response will be 200 to give you a new content, otherwise the response will be: 304 Not Modified, without any content.\\ For more details go to this link: http://tools.ietf.org/html/rfc7232#section-2.3 (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelsIndexAsync($if_none_match = null)
    {
        return $this->getChannelsIndexAsyncWithHttpInfo($if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelsIndexAsyncWithHttpInfo
     *
     * Get public channel index
     *
     * @param  string $if_none_match ETag value to identify the last known version of requested resource.\\ To avoid useless exchange, we recommend you to indicate the ETag you previously got from this operation.\\ If the ETag value does not match the response will be 200 to give you a new content, otherwise the response will be: 304 Not Modified, without any content.\\ For more details go to this link: http://tools.ietf.org/html/rfc7232#section-2.3 (optional)
    ...
    /**
     * Create request for operation 'getChannelsIndex'
     *
     * @param  string $if_none_match ETag value to identify the last known version of requested resource.\\ To avoid useless exchange, we recommend you to indicate the ETag you previously got from this operation.\\ If the ETag value does not match the response will be 200 to give you a new content, otherwise the response will be: 304 Not Modified, without any content.\\ For more details go to this link: http://tools.ietf.org/html/rfc7232#section-2.3 (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelsIndexRequest($if_none_match = null)
    {

        $resourcePath = '/public/channels/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
