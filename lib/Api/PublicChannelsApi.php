...
class PublicChannelsApi
{
    ...
    public function getChannelsWithHttpInfo($country_iso_code, $accept_encoding)
    {
        ...
        // parse inputs
        $resourcePath = "/BeezUP/public_channels/2.0/{countryIsoCode}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/BeezUP/public_channels/2.0/{countryIsoCode}'
            );
    ...
    /**
     * Operation getChannelsByCountry
     *
     ...
     */
    public function getChannelsByCountry()
    {
        list($response) = $this->getChannelsByCountryWithHttpInfo();
        return $response;
    }

    /**
     * Operation getChannelsByCountryWithHttpInfo
     *
     * The channel list regrouped by country
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     */
    public function getChannelsByCountryWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/BeezUP/public_channels/2.0/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
