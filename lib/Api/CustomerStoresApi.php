...
class CustomerStoresApi
{
     ...
     */
    protected function createStoreRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling createStore'
            );
        }

        $resourcePath = '/user/customer/stores';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteStoreRequest($store_id)
    {
        ...
        $resourcePath = '/user/customer/stores/{storeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getStoreWithHttpInfo($store_id, $if_none_match);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoreAsync($store_id, $if_none_match = null)
    {
        return $this->getStoreAsyncWithHttpInfo($store_id, $if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStoreRequest($store_id, $if_none_match = null)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getStoresWithHttpInfo($if_none_match);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoresAsync($if_none_match = null)
    {
        return $this->getStoresAsyncWithHttpInfo($if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStoresRequest($if_none_match = null)
    {
    ...
    {
        $this->updateStoreWithHttpInfo($store_id, $request);
    }
    ...
    {
        $returnType = '';
        $request = $this->updateStoreRequest($store_id, $request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoreAsync($store_id, $request)
    {
        return $this->updateStoreAsyncWithHttpInfo($store_id, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoreAsyncWithHttpInfo($store_id, $request)
    {
        $returnType = '';
        $request = $this->updateStoreRequest($store_id, $request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateStoreRequest($store_id, $request)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling updateStore'
            );
        }
