...
class CatalogsGlobalApi
{
    ...
    /**
     * Operation catalogGetBeezUPColumnsAsync
     *
     * Get the BeezUP columns
     *
     *
     ...
     */
    public function catalogGetBeezUPColumnsAsync()
    {
        return $this->catalogGetBeezUPColumnsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation catalogGetBeezUPColumnsAsyncWithHttpInfo
     *
     * Get the BeezUP columns
     *
     *
    ...
    /**
     * Create request for operation 'catalogGetBeezUPColumns'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogGetBeezUPColumnsRequest()
    {

        $resourcePath = '/user/catalogs/beezupColumns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->catalogIndexWithHttpInfo();
        return $response;
    }

    /**
     * Operation catalogIndexWithHttpInfo
     *
     * Get the index of the catalog API
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogIndexAsync()
    {
        return $this->catalogIndexAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation catalogIndexAsyncWithHttpInfo
     *
     * Get the index of the catalog API
     *
     *
    ...
    /**
     * Create request for operation 'catalogIndex'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function catalogIndexRequest()
    {

        $resourcePath = '/user/catalogs/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
