...
class MarketplacesOrdersAutoTransitionsApi
{
    ...
    {
        $this->configureAutomaticTransitionsWithHttpInfo($request);
    }
    ...
    {
        $returnType = '';
        $request = $this->configureAutomaticTransitionsRequest($request);
    ...
    /**
     * Operation configureAutomaticTransitionsAsync
     *
     * Configure new or existing automatic Order status transition
     *
     * @param  \Swagger\Client\Model\ConfigureAutomaticTransitionRequest $request (required)
     ...
     */
    public function configureAutomaticTransitionsAsync($request)
    {
        return $this->configureAutomaticTransitionsAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation configureAutomaticTransitionsAsyncWithHttpInfo
     *
     * Configure new or existing automatic Order status transition
     *
     * @param  \Swagger\Client\Model\ConfigureAutomaticTransitionRequest $request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configureAutomaticTransitionsAsyncWithHttpInfo($request)
    {
        $returnType = '';
        $request = $this->configureAutomaticTransitionsRequest($request);
     ...
     */
    protected function configureAutomaticTransitionsRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling configureAutomaticTransitions'
            );
        }

        $resourcePath = '/user/marketplaces/orders/automaticTransitions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getAutomaticTransitionsWithHttpInfo($store_id, $if_none_match);
        return $response;
    }
    ...
    /**
     * Operation getAutomaticTransitionsAsync
     *
     * Get list of configured automatic Order status transitions
     *
     * @param  string $store_id The StoreId to filter by (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAutomaticTransitionsAsync($store_id = null, $if_none_match = null)
    {
        return $this->getAutomaticTransitionsAsyncWithHttpInfo($store_id, $if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAutomaticTransitionsAsyncWithHttpInfo
     *
     * Get list of configured automatic Order status transitions
     *
     * @param  string $store_id The StoreId to filter by (optional)
    ...
    /**
     * Create request for operation 'getAutomaticTransitions'
     *
     * @param  string $store_id The StoreId to filter by (optional)
     * @param  string $if_none_match ETag value to identify the last known version of requested resource.\\ To avoid useless exchange, we recommend you to indicate the ETag you previously got from this operation.\\ If the ETag value does not match the response will be 200 to give you a new content, otherwise the response will be: 304 Not Modified, without any content.\\ For more details go to this link: http://tools.ietf.org/html/rfc7232#section-2.3 (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAutomaticTransitionsRequest($store_id = null, $if_none_match = null)
    {
