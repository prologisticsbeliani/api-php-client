...
class MarketplacesOrdersExportsApi
{
    ...
    {
        $this->exportOrdersWithHttpInfo($request);
    }
     ...
     */
    public function exportOrdersWithHttpInfo($request)
    {
        $returnType = '';
        $request = $this->exportOrdersRequest($request);
     ...
     */
    public function exportOrdersAsync($request)
    {
        return $this->exportOrdersAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportOrdersAsyncWithHttpInfo($request)
    {
        $returnType = '';
        $request = $this->exportOrdersRequest($request);
     ...
     */
    protected function exportOrdersRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling exportOrders'
            );
        }

        $resourcePath = '/user/marketplaces/orders/exportations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getOrderExportationsWithHttpInfo($page_number, $page_size, $store_id, $if_none_match);
        return $response;
    }
    ...
    /**
     * Operation getOrderExportationsAsync
     *
     * Get a paginated list of Order report exportations
     *
     * @param  int $page_number The page number you want to get (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderExportationsAsync($page_number, $page_size, $store_id, $if_none_match = null)
    {
        return $this->getOrderExportationsAsyncWithHttpInfo($page_number, $page_size, $store_id, $if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderExportationsAsyncWithHttpInfo
     *
     * Get a paginated list of Order report exportations
     *
     * @param  int $page_number The page number you want to get (required)
    ...
    /**
     * Create request for operation 'getOrderExportations'
     *
     * @param  int $page_number The page number you want to get (required)
     * @param  int $page_size The entry count you want to get (required)
     * @param  string $store_id The store identifier to regroup the order exportations (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrderExportationsRequest($page_number, $page_size, $store_id, $if_none_match = null)
    {
        // verify the required parameter 'page_number' is set
        if ($page_number === null || (is_array($page_number) && count($page_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page_number when calling getOrderExportations'
            );
        }
        if ($page_number < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_number" when calling MarketplacesOrdersExportsApi.getOrderExportations, must be bigger than or equal to 1.');
        }

        // verify the required parameter 'page_size' is set
        if ($page_size === null || (is_array($page_size) && count($page_size) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page_size when calling getOrderExportations'
            );
        }
        if ($page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MarketplacesOrdersExportsApi.getOrderExportations, must be smaller than or equal to 100.');
        }
        if ($page_size < 25) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MarketplacesOrdersExportsApi.getOrderExportations, must be bigger than or equal to 25.');
        }

        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling getOrderExportations'
            );
        }
