...
class CustomerInvoicesApi
{
    ...
    {
        list($response) = $this->getInvoicesWithHttpInfo($if_none_match);
        return $response;
    }
     ...
     */
    public function getInvoicesAsync($if_none_match = null)
    {
        return $this->getInvoicesAsyncWithHttpInfo($if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getInvoicesRequest($if_none_match = null)
    {

        $resourcePath = '/user/customer/invoices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
