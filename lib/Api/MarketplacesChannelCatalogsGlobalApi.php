...
class MarketplacesChannelCatalogsGlobalApi
{
    ...
    /**
     * Operation getMarketplaceChannelCatalogs
     *
    ...
    {
        list($response) = $this->getMarketplaceChannelCatalogsWithHttpInfo($store_id);
        return $response;
    }

    /**
     * Operation getMarketplaceChannelCatalogsWithHttpInfo
     *
     * Get your marketplace channel catalog list
     *
     * @param  string $store_id The StoreId to filter by (optional)
    ...
    /**
     * Operation getMarketplaceChannelCatalogsAsync
     *
     * Get your marketplace channel catalog list
     *
     * @param  string $store_id The StoreId to filter by (optional)
     ...
     */
    public function getMarketplaceChannelCatalogsAsync($store_id = null)
    {
        return $this->getMarketplaceChannelCatalogsAsyncWithHttpInfo($store_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMarketplaceChannelCatalogsAsyncWithHttpInfo
     *
     * Get your marketplace channel catalog list
     *
     * @param  string $store_id The StoreId to filter by (optional)
    ...
    /**
     * Create request for operation 'getMarketplaceChannelCatalogs'
     *
     * @param  string $store_id The StoreId to filter by (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getMarketplaceChannelCatalogsRequest($store_id = null)
    {

        $resourcePath = '/user/marketplaces/channelcatalogs/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
