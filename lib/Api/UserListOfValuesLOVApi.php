...
/**
 * UserListOfValuesLOVApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class UserListOfValuesLOVApi
{
    ...
    {
        $returnType = '\Swagger\Client\Model\UserListOfValuesResponse';
        $request = $this->getUserListOfValuesRequest($list_name, $accept_language, $if_none_match);
    ...
    /**
     * Operation getUserListOfValuesAsync
     *
     * Get the list of values related to this list name
     *
     * @param  string $list_name The list of value name your want to get (required)
     ...
     */
    public function getUserListOfValuesAsync($list_name, $accept_language = null, $if_none_match = null)
    {
        return $this->getUserListOfValuesAsyncWithHttpInfo($list_name, $accept_language, $if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUserListOfValuesAsyncWithHttpInfo
     *
     * Get the list of values related to this list name
     *
     * @param  string $list_name The list of value name your want to get (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserListOfValuesAsyncWithHttpInfo($list_name, $accept_language = null, $if_none_match = null)
    {
        $returnType = '\Swagger\Client\Model\UserListOfValuesResponse';
        $request = $this->getUserListOfValuesRequest($list_name, $accept_language, $if_none_match);
    ...
    /**
     * Create request for operation 'getUserListOfValues'
     *
     * @param  string $list_name The list of value name your want to get (required)
     * @param  string[] $accept_language Indicates that the client accepts the following languages. (optional)
     * @param  string $if_none_match ETag value to identify the last known version of requested resource.\\ To avoid useless exchange, we recommend you to indicate the ETag you previously got from this operation.\\ If the ETag value does not match the response will be 200 to give you a new content, otherwise the response will be: 304 Not Modified, without any content.\\ For more details go to this link: http://tools.ietf.org/html/rfc7232#section-2.3 (optional)
     ...
     */
    protected function getUserListOfValuesRequest($list_name, $accept_language = null, $if_none_match = null)
    {
        // verify the required parameter 'list_name' is set
        if ($list_name === null || (is_array($list_name) && count($list_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $list_name when calling getUserListOfValues'
            );
        }

        $resourcePath = '/user/lov/{listName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        $returnType = '\Swagger\Client\Model\UserLovIndex';
        $request = $this->getUserLovIndexRequest();
    ...
    /**
     * Operation getUserLovIndexAsync
     *
     * Get all list names
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserLovIndexAsync()
    {
        return $this->getUserLovIndexAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUserLovIndexAsyncWithHttpInfo
     *
     * Get all list names
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserLovIndexAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\UserLovIndex';
        $request = $this->getUserLovIndexRequest();
    ...
    /**
     * Create request for operation 'getUserLovIndex'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserLovIndexRequest()
    {

        $resourcePath = '/user/lov/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
