...
class CustomerRightsApi
{
    ...
    {
        list($response) = $this->getRightsWithHttpInfo($store_id);
        return $response;
    }
     ...
     */
    public function getRightsAsync($store_id)
    {
        return $this->getRightsAsyncWithHttpInfo($store_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRightsAsyncWithHttpInfo
     *
     * Get store's rights
     *
     * @param  string $store_id Your store identifier (required)
    ...
    /**
     * Create request for operation 'getRights'
     *
     * @param  string $store_id Your store identifier (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getRightsRequest($store_id)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling getRights'
            );
        }

        $resourcePath = '/user/customer/stores/{storeId}/rights';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
