...
class ChannelCatalogsProductsApi
{
    ...
    /**
     * Operation exportChannelCatalogProductInfoList
     *
    ...
    {
        list($response) = $this->exportChannelCatalogProductInfoListWithHttpInfo($channel_catalog_id, $format, $request);
        return $response;
    }

    /**
     * Operation exportChannelCatalogProductInfoListWithHttpInfo
     *
     * Export channel catalog product information list
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
    ...
    /**
     * Operation exportChannelCatalogProductInfoListAsync
     *
     * Export channel catalog product information list
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     ...
     */
    public function exportChannelCatalogProductInfoListAsync($channel_catalog_id, $format, $request)
    {
        return $this->exportChannelCatalogProductInfoListAsyncWithHttpInfo($channel_catalog_id, $format, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation exportChannelCatalogProductInfoListAsyncWithHttpInfo
     *
     * Export channel catalog product information list
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
    ...
    /**
     * Create request for operation 'exportChannelCatalogProductInfoList'
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     * @param  string $format The file type of the exportation (required)
     * @param  \Swagger\Client\Model\GetChannelCatalogProductInfoListRequest $request The channel catalog product list filter (required)
     ...
     */
    protected function exportChannelCatalogProductInfoListRequest($channel_catalog_id, $format, $request)
    {
        ...
        if ($channel_catalog_id === null || (is_array($channel_catalog_id) && count($channel_catalog_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_catalog_id when calling exportChannelCatalogProductInfoList'
            );
        }
        // verify the required parameter 'format' is set
        if ($format === null || (is_array($format) && count($format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $format when calling exportChannelCatalogProductInfoList'
            );
        }
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling exportChannelCatalogProductInfoList'
            );
        }

        $resourcePath = '/user/channelCatalogs/{channelCatalogId}/products/export';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getChannelCatalogProductByChannelCatalogWithHttpInfo($request);
        return $response;
    }
    ...
    /**
     * Operation getChannelCatalogProductByChannelCatalogAsync
     *
     * Get channel catalog products related to these channel catalogs
     *
     * @param  \Swagger\Client\Model\ChannelCatalogProductByChannelCatalogRequest $request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelCatalogProductByChannelCatalogAsync($request)
    {
        return $this->getChannelCatalogProductByChannelCatalogAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelCatalogProductByChannelCatalogAsyncWithHttpInfo
     *
     * Get channel catalog products related to these channel catalogs
     *
     * @param  \Swagger\Client\Model\ChannelCatalogProductByChannelCatalogRequest $request (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelCatalogProductByChannelCatalogRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling getChannelCatalogProductByChannelCatalog'
            );
        }

        $resourcePath = '/user/channelCatalogs/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getChannelCatalogProductInfoAsync
     *
     * Get channel catalog product information
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelCatalogProductInfoAsync($channel_catalog_id, $product_id)
    {
        return $this->getChannelCatalogProductInfoAsyncWithHttpInfo($channel_catalog_id, $product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelCatalogProductInfoAsyncWithHttpInfo
     *
     * Get channel catalog product information
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
    ...
    /**
     * Create request for operation 'getChannelCatalogProductInfo'
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     * @param  string $product_id The product identifier (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelCatalogProductInfoRequest($channel_catalog_id, $product_id)
    {
        // verify the required parameter 'channel_catalog_id' is set
        if ($channel_catalog_id === null || (is_array($channel_catalog_id) && count($channel_catalog_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_catalog_id when calling getChannelCatalogProductInfo'
            );
        }
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product_id when calling getChannelCatalogProductInfo'
            );
        }

        $resourcePath = '/user/channelCatalogs/{channelCatalogId}/products/{productId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getChannelCatalogProductInfoListAsync
     *
     * Get channel catalog product information list
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelCatalogProductInfoListAsync($channel_catalog_id, $request)
    {
        return $this->getChannelCatalogProductInfoListAsyncWithHttpInfo($channel_catalog_id, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelCatalogProductInfoListAsyncWithHttpInfo
     *
     * Get channel catalog product information list
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelCatalogProductInfoListRequest($channel_catalog_id, $request)
    {
        // verify the required parameter 'channel_catalog_id' is set
        if ($channel_catalog_id === null || (is_array($channel_catalog_id) && count($channel_catalog_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_catalog_id when calling getChannelCatalogProductInfoList'
            );
        }
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling getChannelCatalogProductInfoList'
            );
        }

        $resourcePath = '/user/channelCatalogs/{channelCatalogId}/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getChannelCatalogProductsCounters
     *
    ...
    {
        list($response) = $this->getChannelCatalogProductsCountersWithHttpInfo($channel_catalog_id);
        return $response;
    }

    /**
     * Operation getChannelCatalogProductsCountersWithHttpInfo
     *
     * Get channel catalog products' counters
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
    ...
    /**
     * Operation getChannelCatalogProductsCountersAsync
     *
     * Get channel catalog products' counters
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelCatalogProductsCountersAsync($channel_catalog_id)
    {
        return $this->getChannelCatalogProductsCountersAsyncWithHttpInfo($channel_catalog_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelCatalogProductsCountersAsyncWithHttpInfo
     *
     * Get channel catalog products' counters
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
    ...
    /**
     * Create request for operation 'getChannelCatalogProductsCounters'
     *
     * @param  string $channel_catalog_id The channel catalog identifier (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelCatalogProductsCountersRequest($channel_catalog_id)
    {
        // verify the required parameter 'channel_catalog_id' is set
        if ($channel_catalog_id === null || (is_array($channel_catalog_id) && count($channel_catalog_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_catalog_id when calling getChannelCatalogProductsCounters'
            );
        }

        $resourcePath = '/user/channelCatalogs/{channelCatalogId}/products/counters';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
