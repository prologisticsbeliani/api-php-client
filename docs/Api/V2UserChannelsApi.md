# Swagger\Client\V2UserChannelsApi
...
$api_instance = new Swagger\Client\Api\V2UserChannelsApi();
...
try {
    ...
    echo 'Exception when calling V2UserChannelsApi->getChannelCategories: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling V2UserChannelsApi->getChannelColumns: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling V2UserChannelsApi->getChannelInfo: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling V2UserChannelsApi->getCurrentChannels: ', $e->getMessage(), PHP_EOL;
}
?>
```
