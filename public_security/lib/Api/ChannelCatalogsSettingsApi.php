...
class ChannelCatalogsSettingsApi
{
     ...
     *
     * @return ChannelCatalogsSettingsApi
     */
    ...
    public function configureChannelCatalogCostSettingsWithHttpInfo($channel_catalog_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/settings/cost";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{channelCatalogId}/settings/cost'
            );
    ...
    public function configureChannelCatalogGeneralSettingsWithHttpInfo($channel_catalog_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/settings/general";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{channelCatalogId}/settings/general'
            );
    ...
    public function disableChannelCatalogWithHttpInfo($channel_catalog_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/disable";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function enableChannelCatalogWithHttpInfo($channel_catalog_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{channelCatalogId}/enable";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
