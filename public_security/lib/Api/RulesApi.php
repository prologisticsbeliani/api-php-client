...
class RulesApi
{
    ...
    public function deleteRuleWithHttpInfo($store_id, $rule_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/{ruleId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function disableRuleWithHttpInfo($store_id, $rule_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/{ruleId}/disable";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function enableRuleWithHttpInfo($store_id, $rule_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/{ruleId}/enable";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function getRulesExecutionsWithHttpInfo($store_id, $page_number, $page_size)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/executions";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function moveDownRuleWithHttpInfo($store_id, $rule_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/{ruleId}/movedown";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function moveUpRuleWithHttpInfo($store_id, $rule_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/{ruleId}/moveup";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function runRuleWithHttpInfo($store_id, $rule_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/{ruleId}/run";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function runRulesWithHttpInfo($store_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/rules/run";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
