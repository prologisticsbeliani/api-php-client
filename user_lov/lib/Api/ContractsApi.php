...
class ContractsApi
{
    ...
    {
        // parse inputs
        $resourcePath = "/contracts/current/reenableAutoRenewal";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/contracts/current/reenableAutoRenewal'
            );
    ...
    public function terminateCurrentContractWithHttpInfo($request)
    {
        ...
        // parse inputs
        $resourcePath = "/contracts/current/disableAutoRenewal";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/contracts/current/disableAutoRenewal'
            );
