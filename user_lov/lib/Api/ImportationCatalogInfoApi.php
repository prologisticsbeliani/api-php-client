...
class ImportationCatalogInfoApi
{
    ...
    public function importationConfigureCatalogColumnWithHttpInfo($store_id, $execution_id, $column_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/catalogColumns/{columnId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/catalogColumns/{columnId}'
            );
    ...
    public function importationDeleteCustomColumnWithHttpInfo($store_id, $execution_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/customColumns/{columnId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/customColumns/{columnId}'
            );
    ...
    public function importationGetCustomColumnExpressionWithHttpInfo($store_id, $execution_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/customColumns/{columnId}/expression";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                'string',
                '/{storeId}/importations/{executionId}/customColumns/{columnId}/expression'
            );
    ...
    public function importationGetCustomColumnsWithHttpInfo($store_id, $execution_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/customColumns";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/{storeId}/importations/{executionId}/customColumns'
            );
    ...
    public function importationGetDetectedCatalogColumnsWithHttpInfo($store_id, $execution_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/catalogColumns";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/{storeId}/importations/{executionId}/catalogColumns'
            );
    ...
    public function importationGetProductSampleWithHttpInfo($store_id, $execution_id, $product_sample_index)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/productSamples/{productSampleIndex}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/{storeId}/importations/{executionId}/productSamples/{productSampleIndex}'
            );
    ...
    public function importationGetProductSampleCustomColumnValueWithHttpInfo($store_id, $execution_id, $product_sample_index, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/productSamples/{productSampleIndex}/customColumns/{columnId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                'string',
                '/{storeId}/importations/{executionId}/productSamples/{productSampleIndex}/customColumns/{columnId}'
            );
    ...
    public function importationIgnoreColumnWithHttpInfo($store_id, $execution_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/catalogColumns/{columnId}/ignore";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/catalogColumns/{columnId}/ignore'
            );
    ...
    public function importationMapCatalogColumnWithHttpInfo($store_id, $execution_id, $column_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/catalogColumns/{columnId}/map";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/catalogColumns/{columnId}/map'
            );
    ...
    public function importationMapCustomColumnWithHttpInfo($store_id, $execution_id, $column_id, $request)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/customColumns/{columnId}/map";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/customColumns/{columnId}/map'
            );
    ...
    public function importationReattendColumnWithHttpInfo($store_id, $execution_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/catalogColumns/{columnId}/reattend";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/catalogColumns/{columnId}/reattend'
            );
    ...
    public function importationUnmapCatalogColumnWithHttpInfo($store_id, $execution_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/catalogColumns/{columnId}/unmap";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/catalogColumns/{columnId}/unmap'
            );
    ...
    public function importationUnmapCustomColumnWithHttpInfo($store_id, $execution_id, $column_id)
    {
        ...
        // parse inputs
        $resourcePath = "/{storeId}/importations/{executionId}/customColumns/{columnId}/unmap";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                null,
                '/{storeId}/importations/{executionId}/customColumns/{columnId}/unmap'
            );
