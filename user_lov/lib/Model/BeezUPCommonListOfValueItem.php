...
/**
 * BeezUPCommonListOfValueItem Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BeezUPCommonListOfValueItem implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BeezUP.Common.ListOfValueItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['code_identifier'] === null) {
            $invalid_properties[] = "'code_identifier' can't be null";
        }
        if ($this->container['int_identifier'] === null) {
            $invalid_properties[] = "'int_identifier' can't be null";
        }
