...
class AccountInfoLinks implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'tbd' => '\Swagger\Client\Model\BeezUPCommonLink3'
    ];
    ...
    {
        $this->container['tbd'] = isset($data['tbd']) ? $data['tbd'] : null;
    }
    ...
    {
        return $this->container['tbd'];
    }

    /**
     * Sets tbd
     * @param \Swagger\Client\Model\BeezUPCommonLink3 $tbd
     * @return $this
     */
    public function setTbd($tbd)
    {
        $this->container['tbd'] = $tbd;
